...
export default function DeliveryListBottomSheet({
  visible,
  chooseCollection,
  deliveryMethodList,
  onClose,
  ...
  const renderDeliveryCard = (item, key) => {
    return (
      ...
      >
        <Image
          source={require("../../assets/utilsImage/deliveryIcon2.png")}
          resizeMode="stretch"
        ...
        <View style={styles.collectionCardInfor}>
          ...
          <Text>{formatPrice(item?.price)} VND</Text>
        </View>
      ...
      >
        <View style={styles.sheetContent}>
          ...
          <View style={styles.collectionList}>
            {deliveryMethodList?.map((item, key) =>
              renderDeliveryCard(item, key)
            )}
          </View>
        </View>
      </BottomSheet>
