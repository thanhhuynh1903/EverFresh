...
export default function PlantDetail() {
    ...
    const renderSimilarPlant = (item, key) => {
        return (
            <View style={{ ...styles.similarPlantCard, backgroundColor: key % 2 === 0 ? "#9CE5CB" : "#E5F0A1" }} key={key}>
                <Image
                    // source={require('../../assets/plant details/drop.png')} 
                    source={item.img}
                    resizeMode="contain"
                ...
                <View style={styles.similarPlantCardDetail}>
                    ...
                    <Text style={styles.similarPlantCardDetailValue}>{formatPrice(item.value)} VNĐ</Text>
                </View>
            </View>
        )
    }
        ...
        <>
            <SafeAreaWrapper >
                ...
                <ScrollView style={styles.container}>
                    <View
                        style={styles.plantDetailHeader}
                    >
                        <Image
                    ...
                    <View style={styles.verifyPlant}>
                        <View style={styles.verifyPlantLeft}>
                            ...
                            <Text style={styles.verifyPlantLeftDes}>Just Scan and the AI will know exactly</Text>
                ...
                >
                    <TouchableOpacity style={styles.bottomCartSheetContainer} onPress={() => setModalVisible({ ...modalVisible, cartViewVisible: true })}>
                        <View style={styles.bottomCartSheetContainerLeft}>
                            ...
                            />
                            <Text style={styles.bottomCartSheetContainerLeftCartAmount}>View 3 items</Text>
                        </View>
