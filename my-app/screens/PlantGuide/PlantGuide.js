        ...
        <>
            ...
            <ScrollView showsVerticalScrollIndicator={false} style={styles.container}>
                ...
                <View style={styles.plantInforList}>
                    ...
                    <Text style={styles.plantDescription}>
                        This cultivar has pale yellow flowers with ruffled edges It has a diurnal blooming habit; its blooms remain open from the early morning until the evening. Each flower lasts for only one day.
                    </Text>
                    <Text style={styles.plantDescriptionTitle}>
                        Care
                    </Text>
                    ...
                    <Text style={styles.plantDescription}>
                        Sow seed in containers in spring or autumn. The easiest method is to divide in spring or autumn.
                    </Text>
                    <Text style={styles.plantDescriptionTitle}>
                        Problems
                    </Text>
