...
export const createDeliveryInformation = async (data) => {
  try {
    const response = await api.post(`/delivery-information`, data);
    return response;
  } catch (error) {
    console.log(
      "createDeliveryInformation in service/delivery error : ",
      error
    );
    return error;
  }
...
export const updateDeliveryInformation = async (id, data) => {
  try {
    ...
    console.log(
      "updateDeliveryInformation in service/delivery error : ",
      error
    );
    return error;
  }
...
export const deleteDeliveryInformation = async (id) => {
  try {
    const response = await api.delete(`/delivery-information/${id}`);
    return response;
  } catch (error) {
    console.log(
      "deleteDeliveryInformation in service/delivery error : ",
      error
    );
    return error;
  }
